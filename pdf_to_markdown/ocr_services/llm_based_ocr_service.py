...
DEFAULT_OCR_PROMPT = """\
Extract all text from this image in structured markdown format. Preserve the original layout and formatting as much as possible. 
If the image contains no discernible text, then give a detailed caption of the image.
